    ...
    return {
        ...
        configResolved(config) {
            ...
            if (Array.isArray(config.build.rollupOptions.output) ||
                ((_a = config.build.rollupOptions.output) === null || _a === void 0 ? void 0 : _a.manualChunks)) {
                return;
            }
            (_b = (_c = config.build.rollupOptions).output) !== null && _b !== void 0 ? _b : (_c.output = {});
            config.build.rollupOptions.output.manualChunks = (id) => {
                if (id.includes(prerenderScript) ||
        ...
        transform(code, id) {
            if (id.includes(preloadHelperId)) {
                ...
                s.replace(`const relList = document.createElement('link').relList;`, `if (typeof window === "undefined") return;\n  const relList = document.createElement('link').relList;`);
                s.replace(`const relList = document.createElement("link").relList;`, `if (typeof window === "undefined") return;\n  const relList = document.createElement("link").relList;`);
                return {
                    code: s.toString(),
                    map: s.generateMap({ hires: true }),
